    ...
    <div class="mx-auto flex w-full max-w-xl lg:max-w-screen-xl">
      <div class="mb-16 lg:my-auto lg:max-w-lg">
        <div class="mb-6 max-w-xl">
          <div>
            <p class="bg-teal-accent-400 mb-2 inline-block rounded-full bg-lime-300 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-indigo-900">Diskon 20% tiap tanggal cantik</p>
          </div>
          <h2 class="mb-6 max-w-lg text-3xl font-extrabold text-slate-700 sm:text-5xl sm:leading-snug">
            Selamat Datang <br />
            di 
            <span class="rounded- abg-gradient-to-r inline-block bg-sky-400 from-lime-400 to-sky-400 px-2 font-bold text-white">𝓟𝓮𝓽 𝓟𝓵𝓪𝓬𝓮</span>
          </h2>
    ...
    <div class="flex h-full w-full space-x-3 overflow-hidden md:justify-end">
      ...
      <div class="hidden w-56 items-center space-y-3 lg:flex">
        <div class="overflow-hidden rounded-xl bg-yellow-400">
          <img class="h-full w-full object-cover" src="https://ae01.alicdn.com/kf/H6cca898ad96b44cd9b0f3c4b9edb0e77z/Kotak-Kucing-Persediaan-Kucing-Kayu-Solid-Kandang-Kucing-Mewah-Kandang-Hewan-Peliharaan-Kucing-Kandang-Pembiakan-Kucing.jpg" alt="" />
        </div>
      </div>
      <div class="w-full flex-col space-y-3 rounded-xl py-4 lg:flex lg:w-80">
        <div class="h-40 overflow-hidden rounded-xl bg-green-600/60">
          <img class="mx-auto h-full w-full object-cover" src="https://s1.bukalapak.com/img/615043192/large/rumah_anjing_lucu.jpg" alt="" />
        </div>
        <div class="h-40 overflow-hidden rounded-xl bg-pink-600/60">
          <img class="mx-auto h-full w-full object-cover" src="https://assets.ayobandung.com/crop/0x0:0x0/750x500/webp/photo/2023/05/24/1JPG-1920943149.jpg" alt="" />
        </div>
        <div class="h-40 overflow-hidden rounded-xl bg-blue-600/60">
          <img class="mx-auto h-full w-full object-cover" src="https://media.istockphoto.com/id/1479525503/id/foto/mainan-hewan-peliharaan-dan-makanan-dengan-latar-belakang-biru-mainan-anjing-perlengkapan.jpg?s=1024x1024&w=is&k=20&c=QqCy94d-dR7zhx2g4ECADpQdHwRLnBkvrDuYgL8Ojk0=" alt="" />
        </div>
      </div>
    </div>
    <!-- /Right Column -->
...
<section class="py-20">
  <div class="mx-auto grid max-w-screen-xl grid-cols-1 gap-6 p-6 md:grid-cols-2 lg:grid-cols-3">
    <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl">
      <a href="#">
        ...
        <div class="mt-1 p-2">
          <h2 class="text-slate-700">Pedigree</h2>
          <p class="text-slate-400 mt-1 text-sm">Makanan Anjing</p>
    ...
    <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl">
      <a href="#">
        ...
        <div class="mt-1 p-2">
          <h2 class="text-slate-700">Whiskas</h2>
          <p class="text-slate-400 mt-1 text-sm">Makanan Kucing</p>
    ...
    <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl">
      <a href="#">
        ...
        <div class="mt-1 p-2">
          <h2 class="text-slate-700">Happy Jungle</h2>
          <p class="text-slate-400 mt-1 text-sm">Makanan Burung</p>
  ...
  <span class="group flex w-full items-center justify-center rounded py-1 text-center font-bold"><a href="/product"> Selengkapnya </a></span>
...
<footer class="relative mt-20 bg-gray-900 px-4 pt-20">
  <div class="absolute -top-10 left-1/2 h-16 w-16 -translate-x-1/2 rounded-xl border-4 border-sky-500 bg-white p-2"><img class="h-full object-contain" src="https://cdn-icons-png.flaticon.com/512/1145/1145724.png" alt="" /></div>
  ...
  <p class="py-10 text-center text-gray-300">© 2023 𝓟𝓮𝓽 𝓟𝓵𝓪𝓬𝓮 | All Rights Reserved</p>
</footer>
