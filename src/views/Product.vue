  ...
  <div class="mx-auto grid max-w-screen-xl grid-cols-1 gap-6 p-6 md:grid-cols-2 lg:grid-cols-3">
    <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl">
      <a href="#">
        ...
        <div class="mt-1 p-2">
          <h2 class="text-slate-700">Tulang Gigit</h2>
          <p class="text-slate-400 mt-1 text-sm">Mainan Anjing</p>
    ...
    <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl">
      <a href="#">
        ...
        <div class="mt-1 p-2">
          <h2 class="text-slate-700">Chewing toy</h2>
          <p class="text-slate-400 mt-1 text-sm">Mainan Kelinci</p>
  ...
  <div class="mx-auto grid max-w-screen-xl grid-cols-1 gap-6 p-6 md:grid-cols-2 lg:grid-cols-3">
    <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl">
      <a href="#">
        ...
        <div class="mt-1 p-2">
          <h2 class="text-slate-700">Baju Minion</h2>
          <p class="text-slate-400 mt-1 text-sm">Pakaian Anjing</p>
    ...
    <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl">
      <a href="#">
        ...
        <div class="mt-1 p-2">
          <h2 class="text-slate-700">Baju Polkadot</h2>
          <p class="text-slate-400 mt-1 text-sm">Pakaian Kucing</p>
